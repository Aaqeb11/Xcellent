  ...
  return (
    <>
      ...
      <div className="hidden sm:block mt-[100px]">
        <div className="w-full px-4 md:px-[5.313vw]">
          <div className="flex flex-wrap justify-center">
            {Data.map((data, index) => (
              <div key={index} className="flex flex-col items-center px-2 mb-8 md:mb-0 md:w-1/2 lg:w-1/4">
                <Image src={data.img} alt="img" className="w-40 h-auto" />
