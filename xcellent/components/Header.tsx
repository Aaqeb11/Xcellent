...
export const Header = () => {
  ...
  return (
    <>
      <header
        className={`fixed flex justify-between w-full px-1 md:p-2 max-h-[87px]  z-20 ${
      ...
      >
        ...
        <div className="hidden lg:block pt-2">
          <button className="relative overflow-hidden group p-4 rounded-[10px] text-white font-bold border-2 border-transparent hover:border-[#9E0506] transition-colors duration-300">
      ...
      <div
        className={`fixed top-0 right-0 w-64 bg-black z-50 transform transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <div className="flex flex-col  justify-between h-full py-[80px]">
          <div className="flex flex-col gap-8 pl-10">
            <p className="text-white font-bold hover:text-[#e20303] cursor-pointer mb-4">
